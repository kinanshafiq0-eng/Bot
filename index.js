...
// ==========================================
// قاعدة بيانات 80 دولة مع أعلام وصور ديناميكية
// تم تحسين الرابط لجلب صور من داخل الدولة بشكل أفضل
// ==========================================
const countryData = [
...
// توليد قاعدة البيانات النهائية مع رابط صورة ديناميكي
// استخدام featured مع كلمات مفتاحية للحصول على صور من داخل الدولة
const worldCountriesDatabase = countryData.map(c => ({
    ...c,
    image: `https://source.unsplash.com/featured/800x600/?${encodeURIComponent(c.name)},city,landmark`
}));
...
client.on('messageCreate', async message => {
    ...
    // ==========================================
    // 4. لعبة تخمين البلد الجغرافي (6 جولات مع صور ديناميكية)
    // ==========================================
