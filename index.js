...
const rebeccaDatabase = {
    ...
    'حيوان': [
        'ارنب', 'اسد', 'افعى', 'ايل', 'اتان', 'افاتار',
        'بطريق', 'بقر', 'باز', 'ببغاء', 'برديس', 'ببر',
        'تمساح', 'تنين', 'تيس',
        'ثعلب', 'ثور', 'ثعبان',
        ...
        'راكون', 'رنة', 'رفراف',
        'زرافة', 'زنبور', 'زبابة',
        'سنجاب', 'سمك', 'سرطان', 'سلاحف', 'سبع', 'سحیلیه',
        'شاهين', 'شص', 'شمبانزي',
        'صقر', 'صائد', 'صيصان',
        'ضفدع', 'ضب', 'ضبع',
        'ظبي', 'ظربان',
        'عجل', 'عصفور', 'عقرب', 'عنكبوت', 'غراب', 'عناق',
        'غزال', 'غرنوق', 'غلاب',
        'فيل', 'فهد', 'فار', 'فلامنجو', 'فقمة',
        'قرد', 'قط', 'قنفذ', 'قطرس', 'قندس',
        'كلب', 'كوالا', 'كنغر', 'كراكي',
        'لجأة', 'لاما', 'لقلق',
    ...
    'نبات': [
        'ارز', 'اناناس', 'افوكادو', 'اسطواني', 'ازهار',
        'بصل', 'برتقال', 'بطاطس', 'بامية', 'بروكلي', 'باذنجان', 'بلح',
        'تفاح', 'تمر', 'ترمس', 'تين',
        'ثوم', 'ثمامة',
        'جزر', 'جوافة', 'جوز', 'جرجير', 'جبن',
        'حمص', 'حلبة', 'حرمل', 'حبق', 'حناء',
        'خيار', 'خس', 'خوخ', 'خردل', 'خيزران',
        'دراق', 'دخن', 'دباء', 'داتورا',
        'ذرة', 'ذعلوق',
        'رمان', 'ريحان', 'رشاد', 'رويد',
        'زيتون', 'زعتر', 'زعفران', 'زنجبيل',
        'سبانخ', 'سماق', 'سنديان', 'سذاب', 'سنبل',
    ...
    'جماد': [
        'ابريق', 'اسفنج', 'اسوارة', 'استيكر', 'الماس',
        'باب', 'برطمان', 'برج', 'برواز', 'بطانية', 'بلوزة', 'برميل', 'بوصلة',
        'تاج', 'تلفزيون', 'تفصيل', 'تمثال', 'ترابيزة', 'تفاحه',
        'ثوب', 'ثلاجة', 'ثريا', 'ثقب',
        'جدار', 'جسر', 'جهاز', 'جريدة', 'جاموسة', 'جزمة', 'جلابية',
        'حذاء', 'حائط', 'حزام', 'حبل', 'حديدة', 'حاسوب', 'حقيبة',
        'خاتم', 'خزانة', 'خشبة', 'خيمة', 'خيط', 'خلائط',
        'درج', 'دلو', 'دبوس', 'دراجة', 'درع', 'دشداشة',
        'ذهب', 'درهم',
        'راديو', 'رسالة', 'رمح', 'رواق', 'ربطة',
        'زجاج', 'نبور', 'زاوية', 'نبور', 'زر', 'زبرجد', 'زنبرك',
        'سرير', 'ساعة', 'سيارة', 'سجادة', 'سيف', 'سلك', 'سلسلة', 'ستارة',
        'شباك', 'شاشة', 'شوكة', 'شمعدان', 'شمعة', 'شارع', 'شريط',
        'صندوق', 'صنبور', 'صاروخ', 'صينية', 'صخرة', 'صابون',
        'طاولة', 'طبلة', 'طوبة', 'طائرة', 'طوق', 'طربوش', 'طين',
        'ظرف', 'ظلال',
        'عصا', 'عقد', 'عربة', 'علم', 'عطر', 'عكاز',
        'غسالة', 'غطاء', 'غرشة', 'غرفة',
        'فأس', 'فنجان', 'فرن', 'فرشاة', 'فازة', 'فستان', 'فوطة',
        'قلم', 'قفل', 'قدر', 'قميص', 'قارب', 'قنينة', 'طاقية',
        'كتاب', 'كرسي', 'كأس', 'كمبيوتر', 'كوتشين', 'مكتب',
        'لابتوب', 'لعبة', 'لوحة', 'لجام', 'لسان',
        'مفتاح', 'مصباح', 'مروحة', 'منشفة', 'مقص', 'محفظة', 'مرآة', 'ملعقة',
        'نظارة', 'نجفة', 'نول', 'وسادة',
        'هاتف', 'هودي', 'هيكل', 'هرم',
        'وسادة', 'ورقة', 'وسام', 'وتد',
        'يمامة', 'يخت'
    ],
    'بلاد': [
        'اردن', 'اسبانيا', 'امريكا', 'المانيا', 'ايطاليا', 'ايران', 'استراليا', 'امارات', 'اسكتلندا', 'ارمينيا', 'البانيا',
        'برازيلي', 'بريطانيا', 'بلجيكا', 'بلغاريا', 'باراغواي', 'بحرين', 'بروناي', 'بنغلاديش',
                ...
                while (gameRunning) {
                    ...
                    await new Promise((resolve) => {
                        chatCollector.on('collect', async m => {
                            ...
                            // التحقق هل الكلمة تنتمي للفئة أم لا من قاعدة البيانات
